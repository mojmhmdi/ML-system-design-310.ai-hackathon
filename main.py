...
def function_updator (model):
    if time.time()%(3600*6) ==0:
        ...
        data_replies1.to_pickle('cathiedwood_replies.pkl')
        data_owner1.to_pickle('cathiedwood_owner.pkl')
        data_replies2.to_pickle('ylecun_replies.pkl')
        data_owner2.to_pickle('ylecun_owner.pkl')
        data_replies3.to_pickle('taylorlorenz_replies.pkl')
